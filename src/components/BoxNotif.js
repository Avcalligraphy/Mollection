...
const BoxNotif = () => {
  return (
    <div className="h-[112px] w-full rounded-[5px] shadow-md px-[16px] py-[8px] shadow-gray-500">
      <h1 className="text-[14px] font-semibold text-black">Penggunaan Listrik 5 kWH</h1>
      <p className="mt-[7px] text-[11px] text-black ">
        Harap Mengurangi Penggunaan Listrik, <br /> Atau segera mengaudit konsumsi listrik
      </p>
